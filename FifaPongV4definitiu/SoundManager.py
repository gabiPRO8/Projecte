...
class SoundManager:
    def __init__(self):
        ...
        self.player_select_sounds = {
            ...
            "Zidane": pygame.mixer.Sound("sounds/zinedinzidan.mp3"),
            "Johan Cruyff": pygame.mixer.Sound("sounds/johancruyff.mp3"),
            "Casillas": pygame.mixer.Sound("sounds/vamoscasillas.mp3")
        }
        ...
        self.player_select_sounds["Zidane"].set_volume(10)      # Volumen más alto para Zidane
        self.player_select_sounds["Johan Cruyff"].set_volume(1.9)  # Volumen más alto para Cruyff
        self.player_select_sounds["Casillas"].set_volume(0.9)    # Volumen más alto para Casillas
        self.background_music.set_volume(0.1)  # Volumen más bajo para la música de fondo
